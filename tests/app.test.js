...
const installedSceneStart = sceneSevenSource.indexOf('function installSceneSevenV2()');
const installedSceneEnd = sceneSevenSource.indexOf('\ninstallSceneSevenV2();', installedSceneStart);
const installedScene = installedSceneStart >= 0 && installedSceneEnd > installedSceneStart ? sceneSevenSource.slice(installedSceneStart, installedSceneEnd) : '';
